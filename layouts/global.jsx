...
export default function GlobalLayout({title, part, description, children}) {
    const {projectTitle, projectDescription} = config
    ...
    return (
        <>
            ...
            <SocialMetaTags title={htmlTitle} description={description} />

            <header
                className='z-40 md:shadow-md bg-gray-200 dark:bg-gray-800 fixed w-screen top-0 h-10 md:h-14 font-medium'>
                <NavBar/>
            </header>
